    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-gradient-to-b from-black/60 to-transparent">
      <nav className="container mx-auto px-6 py-2 flex items-center justify-between">
        ...
        <ul className="hidden md:flex space-x-10 text-white text-sm tracking-wide font-p22-mackinac">
          <li><Link href="/" className="hover:text-gray transition font-medium">HOME</Link></li>
          <li><Link href="/about" className="hover:text-gray transition font-medium">ABOUT</Link></li>
          <li><Link href="/treatments" className="hover:text-gray transition font-medium">TREATMENTS</Link></li>
          <li><Link href="/gallery" className="hover:text-gray transition font-medium">GALLERY</Link></li>
          <li><Link href="/contact" className="hover:text-gray transition font-medium">CONTACT</Link></li>
        </ul>
